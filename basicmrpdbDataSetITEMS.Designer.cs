...
namespace BasicMRP {
    ...
    public partial class basicmrpdbDataSetITEMS : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/basicmrpdbDataSetITEMS.xsd";
        ...
        public partial class itemDataTable : global::System.Data.TypedTableBase<itemRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public itemRow AdditemRow(string itemcode, string itemname, string itemtype, string unitcode) {
...
namespace BasicMRP.basicmrpdbDataSetITEMSTableAdapters {
    ...
    public partial class itemTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[item] WHERE (([id] = @Original_id) AND ([itemcode] = @Original" +
                "_itemcode) AND ([itemname] = @Original_itemname) AND ([itemtype] = @Original_ite" +
                "mtype) AND ([unitcode] = @Original_unitcode))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[item] ([itemcode], [itemname], [itemtype], [unitcode]) VALUES " +
                "(@itemcode, @itemname, @itemtype, @unitcode);\r\nSELECT id, itemcode, itemname, it" +
                "emtype, unitcode FROM item WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[item] SET [itemcode] = @itemcode, [itemname] = @itemname, [itemtype] = @itemtype, [unitcode] = @unitcode WHERE (([id] = @Original_id) AND ([itemcode] = @Original_itemcode) AND ([itemname] = @Original_itemname) AND ([itemtype] = @Original_itemtype) AND ([unitcode] = @Original_unitcode));
SELECT id, itemcode, itemname, itemtype, unitcode FROM item WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, itemcode, itemname, itemtype, unitcode FROM dbo.item";
        ...
        public virtual int Delete(int Original_id, string Original_itemcode, string Original_itemname, string Original_itemtype, string Original_unitcode) {
        ...
        public virtual int Insert(string itemcode, string itemname, string itemtype, string unitcode) {
            if ((itemcode == null)) {
        ...
        public virtual int Update(string itemcode, string itemname, string itemtype, string unitcode, int Original_id, string Original_itemcode, string Original_itemname, string Original_itemtype, string Original_unitcode, int id) {
            if ((itemcode == null)) {
                throw new global::System.ArgumentNullException("itemcode");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string itemcode, string itemname, string itemtype, string unitcode, int Original_id, string Original_itemcode, string Original_itemname, string Original_itemtype, string Original_unitcode) {
            return this.Update(itemcode, itemname, itemtype, unitcode, Original_id, Original_itemcode, Original_itemname, Original_itemtype, Original_unitcode, Original_id);
        }
    }
